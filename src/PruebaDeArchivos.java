        ...
        PruebaDeArchivos mf  = new PruebaDeArchivos();
                ...
                while(true){
                    ...
                    if(menu==3){
                        ...
                        try {
                            File archivo = new File(nombre + "/datos.bin");
                            java.io.DataInputStream entrada = new java.io.DataInputStream(new java.io.FileInputStream(archivo));
                            String nombreArchivo = entrada.readUTF();
                            String contrasenaArchivo = entrada.readUTF();
                            entrada.close();
                            
                            MisDatos datos = new MisDatos(nombreArchivo, contrasenaArchivo);
